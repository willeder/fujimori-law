...
export function PaymentHistory({ payments, onUpdate, onAdd, readonly = false }: PaymentHistoryProps) {
  ...
  const columns: Column<PaymentRecord>[] = [
    ...
    ...(readonly
      ...
      : [
          {
            key: 'actions' as keyof PaymentRecord,
            header: '',
            width: '80px',
